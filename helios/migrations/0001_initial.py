    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_perm_open', models.CharField(default=b'nobody', max_length=300, choices=[(b'anyone', b'Anyone'), (b'themselves', b'Themselves'), (b'nobody', b'Nobody')])),
                ('audit_perm_close', models.CharField(default=b'anyone', max_length=300, choices=[(b'anyone', b'Anyone'), (b'themselves', b'Themselves'), (b'nobody', b'Nobody')])),
                ('admin_perm_open', models.BooleanField(default=False)),
                ('admin_perm_close', models.BooleanField(default=True)),
